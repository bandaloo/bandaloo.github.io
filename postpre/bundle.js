...
},{"@bandaloo/merge-pass":64}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.CelShade = void 0;
const merge_pass_1 = require("@bandaloo/merge-pass");
class CelShade extends merge_pass_1.WrappedExpr {
    constructor() {
        const mult = merge_pass_1.pfloat(0.8);
        const bump = merge_pass_1.pfloat(0.3);
        const center = merge_pass_1.pfloat(0.3);
        const edge = merge_pass_1.pfloat(0.03);
        const smooth = merge_pass_1.cfloat(merge_pass_1.tag `(smoothstep(-${edge} + ${center}, ${edge} + ${center}, ${merge_pass_1.rgb2hsv(merge_pass_1.fcolor())}.z) * ${mult} + ${bump})`);
...
},{"@bandaloo/merge-pass":64}],3:[function(require,module,exports){
"use strict";
...
const A = __importStar(require("./exampleanimations"));
const P = __importStar(require("./index"));
const celshade_1 = require("./celshade");
const slow = false;
...
const demos = {
    ...
    blurandtracedepth: (channels = []) => {
        let bt;
        const merger = new MP.Merger([(bt = P.blurandtrace(MP.mut(1), MP.mut(1), 4, 13, 0, true))], sourceCanvas, gl, { channels: channels });
        class BlurAndTraceControls {
            constructor() {
                this.brightness = 1;
                this.blur = 1;
    ...
    noisedisplacement: (channels = []) => {
        let nd;
        const merger = new MP.Merger([(nd = P.noisedisplacement())], sourceCanvas, gl, {
            channels: channels,
        });
        class LightBandsControls {
            constructor() {
    ...
    oldfilm: (channels = []) => {
        let olf;
        const merger = new MP.Merger([(olf = P.oldfilm()), P.vignette(3, 1.5)], sourceCanvas, gl, { channels: channels });
    ...
    celshade: (channels = []) => {
        const merger = new MP.Merger([new celshade_1.CelShade()], sourceCanvas, gl, {
            channels: channels,
        });
        return {
            merger: merger,
...
const notes = {
    foggyrays: "this adds some texture to the effect you would normally get with <code>godrays</code>",
    vignette: "this effect blurs and darkens the edges",
    blurandtracescene: "this effect blurs the scene and traces back over it with lines. you need to supply a " +
    ...
    blurandtracedepth: "you can use <code>blurandtrace</code> with the depth buffer to get an even " +
        ...
        "to true",
    lightbands: "you can light up and darken strips of your scene if you supply a depth buffer",
    noisedisplacement: "depending on the parameters, <code>noisedisplacement</code> can make things look as though " +
        "they are underwater or behind textured glass",
    oldfilm: "this adds random vertical scratches and specks of dust, as well as film grain. this pairs " +
...
},{"./celshade":2,"./exampleanimations":4,"./index":6,"@bandaloo/merge-pass":64,"dat.gui":12}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.celTest = exports.bloomTest = exports.higherOrderDonuts = exports.higherOrderPerspective = exports.movingGrid = exports.pinkishHelix = exports.vectorSpiral = exports.higherOrderGoo = exports.bitwiseGrid = exports.uncommonCheckerboard = exports.higherOrderWaves = exports.shaderLike = exports.fabric = exports.redSpiral = exports.higherOrderSpiral = exports.stripes = void 0;
// dwitter sim
let C = Math.cos;
let S = Math.sin;
let T = Math.tan;
let R = (r, g, b, a = 1) => `rgba(${r | 0},${g | 0},${b | 0},${a})`;
exports.stripes = (t, frames, x, c) => {
    if (frames === 0) {
        x.fillStyle = "black";
...
exports.higherOrderSpiral = (dots, background, num = 50, size = 1, speed = 1) => (t, frames, x, c) => {
...
exports.redSpiral = (t, frames, x, c) => {
    x.fillStyle = "white";
    x.fillRect(0, 0, 960, 540);
    let d;
    for (let i = 50; (i -= 0.5);) {
...
exports.vectorSpiral = (t, frames, x, c) => {
    x.fillStyle = "black";
    x.fillRect(0, 0, 960, 540);
    let d;
    x.lineWidth = 2;
...
exports.pinkishHelix = (t, frames, x, c) => {
    x.fillStyle = "white";
    x.fillRect(0, 0, 960, 540);
    let i, j;
    for (i = 0; i < 960; i += 32) {
...
exports.movingGrid = (t, frames, x, c) => {
    let i, j, s;
    c.width |= 0;
    for (i = 940; (i -= 20);)
        for (j = 520; (j -= 20);)
...
exports.higherOrderPerspective = (color, normalized = true) => {
    const layerNum = 12;
    const fillFunc = color
        ? (i) => `hsl(${i * 99},50%,50%)`
...
exports.higherOrderDonuts = (color = true, extra = 0) => {
...
exports.bloomTest = (t, frames, x, c) => {
    const hsize = 32;
    const spacing = 100;
    x.fillStyle = "black";
    x.fillRect(0, 0, 960, 540);
...
},{"@bandaloo/merge-pass":64}],6:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./blurandtrace":1,"./foggyrays":5,"./kaleidoscope":7,"./lightbands":8,"./noisedisplacement":9,"./oldfilm":10,"./vignette":11}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@bandaloo/merge-pass":64}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@bandaloo/merge-pass":64}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@bandaloo/merge-pass":64}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@bandaloo/merge-pass":64}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@bandaloo/merge-pass":64}],12:[function(require,module,exports){
/**
